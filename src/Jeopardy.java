	...
	public class Jeopardy implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(buttonPressed.equals(firstButton)){
				askQuestion("What is the best type of Dog", "Snoop Dogg", 200);
			}
				...
				askQuestion("What starts with A and ends with A.  Hint(it is in this question)","A",300);
			}else if (buttonPressed.equals(thirdButton)){
				askQuestion("What is eminem","Not afraid",800);
			}
		...
		private void askQuestion(String question, String correctAnswer, int prizeMoney) {
			// Remove this temporary message
			String correct = JOptionPane.showInputDialog(null, question);
			// Use a pop up to ask the user the question
			
			// If the answer is correct
			if(correct.equals(correctAnswer)){
				prizeMoney ++;
				updateScore();
				...
				prizeMoney --;
				updateScore();
				JOptionPane.showMessageDialog(null, "*Donald Trump voice*  WRONG");
			}
